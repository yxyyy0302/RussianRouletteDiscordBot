...
public class Rules implements Command {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        embedBuilder.addField("Rule 4", "If the gun does not go off, the gun will be passed to the other player and the game will continue until either players dies.", false);
